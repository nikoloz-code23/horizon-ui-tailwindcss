...
If you want to run the project locally, then simply clone it:
```bash
# Clone with SSH
git clone git@github.com:nikoloz-code23/horizon-ui-tailwindcss.git
# Or clone with HTTPS
git clone https://github.com/nikoloz-code23/horizon-ui-tailwindcss.git
```
